...
//  VideoDemo
//
//  Created by EGLS_BMAC on 2020/6/5.
//  Copyright © 2020 EGLS_BMAC. All rights reserved.
//

#import "LRFFmpegTool.h"
...
//    NSString *input_str= [NSString stringWithFormat:@"resource.bundle/%@",self.input.text];
    ...
    for (i = 0; i < ifmt_ctx->nb_streams; i++) {
        ...
        if (ofmt_ctx->oformat->flags & AVFMT_GLOBALHEADER) {// TODO
...
- (void)showDevice{
    ...
    printf("=============================\n");
    int ret = avformat_open_input(&pFormatCtx,"0",iformat,NULL);
    if(ret!=0){
        printf("Couldn't open input stream.\n ret = %d",ret);
        return ;
    }
