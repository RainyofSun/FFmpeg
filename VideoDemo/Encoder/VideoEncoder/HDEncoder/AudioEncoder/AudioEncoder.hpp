...
private:
    ...
    int audio_encode(void *(*AudioEncoderCallBack)(MediaAudioPacket audio_packet));
...
public:
     ...
     * 开始编码
     */
    int aacEncode(byte *buffer, int size,void *(*AudioEncoderCallBack)(MediaAudioPacket audio_packet));
